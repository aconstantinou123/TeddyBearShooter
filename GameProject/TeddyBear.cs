...
namespace GameProject
{
    ...
    public class TeddyBear
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (elapsedShotMilliseconds + gameTime.ElapsedGameTime.Milliseconds > firingDelay)
            {
                ...
                Projectile teddyProjectile = new Projectile(ProjectileType.TeddyBear,
                    ...
                    drawRectangle.Y + GameConstants.TeddyBearProjectileOffset, GetProjectileYVelocity()/ -1);
